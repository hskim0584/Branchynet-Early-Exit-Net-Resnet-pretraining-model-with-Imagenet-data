...
class IntrFE(nn.Module):
    ...
    def __init__(self, chanIn, interChans=1024, last_conv_chan=2048):
        ...
        self.conv3 = ConvBasic(interChans, last_conv_chan, k=3, s=2, p=1)
...
class IntrFE2(nn.Module):
    ...
    def __init__(self, chanIn, interChans=512, last_conv_chan=2048):
        ...
        self.conv1 = ConvBasic(chanIn, interChans, k=5, s=2, p=2)
        layers.append(self.conv1)
        self.conv2 = ConvBasic(interChans, last_conv_chan, k=3, s=2, p=1)
        layers.append(self.conv2)
        self.layers = layers
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=2):
        ...
        self.InterFE1 = IntrFE(64)

        self.layer1 = self._make_layer(block, 64, layers[0])
        self.layer2 = self._make_layer(block, 128, layers[1], stride=2)

        self.InterFE2 = IntrFE2(512)
